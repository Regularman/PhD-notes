...
| Solar Thermal                | Solar thermal can be firmed with PCM TES to achieve more stable output temperatures and efficient operations.                                                                                                                                                                                                                                                                                   | Recent works involve coatings to improve absorptivity, integrating reflectors, heat pipes or TES and developing advanced working fluids. Future technologies may reach higher thermal efficiency at higher temperatures.                                                                                                                                                                                                                                                                                                                                          |
| PCM - TES                    |                                                                                                                                                                                                                                                                                                                                                                                                 | Need to look into the development of phase changing TES. Alsso using liquidefied air as a storage mediu                                                                                                                                                                                                                                                                                                                                                                                                                                                           |