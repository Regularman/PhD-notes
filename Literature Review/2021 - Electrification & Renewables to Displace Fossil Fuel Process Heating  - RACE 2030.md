...
| Biogas and waste combustion  | Note that biogas is used in commercial use and needs to be upgraded into bio-methane for use in C&I. Capacity for biogas combustion is concentrated in the US, Germany, and China. The share of bio-methane                                            | Where biogas is methane, CO2, and water vapour mixture, bio-methane is a highly refined product. The former is much less energy dense and can be scrubbed or membrane separated to obtain higher purity bio-methane. Bio-methane is completely indistinguishable from natural gas and there is no limit to injection into the gas pipeline. Note that there is a push to move biogas to CHP, which has a higher energy efficiency. |
|                              |                                                                                                                                                                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                                                    |