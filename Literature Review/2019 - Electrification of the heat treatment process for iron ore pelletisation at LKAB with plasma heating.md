...
| Power required per tonne of sinter | $1.29GJ/t$. See above. However, LKAB states that they have reduced fuel consumption to $8L/t$, which is around $0.308GJ/t$. However, another thing to note is that where other plants process hematite, that needs a higher input of energy ($15L/t$) as there is not exothermic oxidation to provide additional energy. [Source](https://minedocs.com/21/Malmberget_PlantUpgrade_2008.pdf)                                                                                                            | $1.29GJ/t$. See above.                    |
