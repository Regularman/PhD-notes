...
| Power required per tonne of sinter | $1.29GJ/t$. See above.                                                                                                                                                                                                                                        | $1.29GJ/t$. See above.                    |
| Sinter to DRI efficiency           | $1.5t$                                                                                                                                                                                                                                                        |                                           |
| Carbon emissions                   | $222.525 kgCO2-eq/t-CS$. note that this is consistent with [[2017 - Power-to-Steel - Reducing CO2 through the integration of Renewable Energy and Hydrogen into the German Steel Industry]], which states that sintering releases approximately $271kg/t-CS$. | Potentially 0 with renewable electricity. |
...
- The model performs calculations for chemical reactions as well as mass and heat transfer between the process gas and the bed. The main goal of the simulation model is to calculate the NOX formation of the plasma gun case using a reactor model, as well as the degree of oxidation from magnetite into hematite, the gas temperature throughout the grate, and the pellet temperature.