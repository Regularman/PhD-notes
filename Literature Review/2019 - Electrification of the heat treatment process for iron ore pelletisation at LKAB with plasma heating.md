...
| Carbon emissions                   | $222.525 kgCO2-eq/t-CS$. note that this is consistent with [[2017 - Power-to-Steel - Reducing CO2 through the integration of Renewable Energy and Hydrogen into the German Steel Industry]], which states that sintering releases approximately $271kg/t-CS$. However, note that in this paper, LKAB states that they have reduced carbon emissions to around $3 | Potentially 0 with renewable electricity. |
