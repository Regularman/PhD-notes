...
| Process                      | Input | Temperature       | Purpose                                                                                                                                                                                            | Share of energy and GHG |
| ---------------------------- | ----- | ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| Grain mashing                |       | $45-75 \degree C$ | Crushed malted grains are mixed with hot water to activate natural enzyme, turning insoluble starch into simple fermentable sugars that goes into the wort solution. A mash tun is just a big tub  |                         |
