...
- High temperature Bayer's process is also required at a much higher pressure, $5 MPa$. Therefore, in a low temperature plant, the steam generated from natural gas boilers, can be passed through a co-generation plant to sell electricity back to the grid the 
#### Waste heat
