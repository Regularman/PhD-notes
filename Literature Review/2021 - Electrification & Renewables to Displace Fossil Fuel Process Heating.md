...
| Hall-Heroult process       | Alumina and electricity |             | Smelt alumina into aluminium. Alumina is placed into an electrolytic solution with a cathode and anode and is reduced to form molten aluminium at the bottom of the cell when electricity is placed into the process. |                         |
#### Bayer's Process
