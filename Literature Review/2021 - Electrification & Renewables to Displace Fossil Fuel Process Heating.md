...
| Technology       | Use case                                                                                                                                                |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Recovery boilers Instead of using conventional gas fired boilers to produce thermal energy, it uses blakc liquor, which is a byproduct of chemical pulp manufacturing,  g  |