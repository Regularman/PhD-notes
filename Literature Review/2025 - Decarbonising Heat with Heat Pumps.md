...
| Sub-coller        | Increase COP of heat pumps for low temperature applications. It uses an external heat sink to reduce throttling losses and refrigerant flow rate. However, the maximum temperature lift is still limited by the pressure ratio of a single compression stage. |
