...
| How can these barriers and knowledge gaps be overcome | Large scale trials are required to explore and incentivise consumer and also for operators to better understand consumer archetypes. We also need to quantify these risks and benefits. In addition to industrial projects, we also need |        |            |                 |
