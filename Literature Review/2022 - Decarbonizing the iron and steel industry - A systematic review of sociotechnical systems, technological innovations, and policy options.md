...
| Hydrogen                                               | Hydrogen can be used as a reducing agent. Simulation shows that DRI can reduce up to 91% of direct CO2 emissions related to using natural gas [21]. ~={blue}Can incorporate ISP hydrogen modelling? But this may be circular as ISP hydrogen modelling comes from the =~. Furthermore, the applicatiLow-carbon hydrogen-based direct reduction, off-gas hydrogen enrichment, electrolytic hydrogen blending, natural gas-based with high levels of electrolytic hydrogen blending, hydrogen for high-temperature heat (ancillary processes) | Projects are running which investigates this, such as Ulcos, Hybrit, SuSteel, Salcos-Macor, ArcelorMittal, and Flash iron making. [141] [142] shows that hydrogen has the potential to mitigate 3Gt of CO2 annually from iron and steel making production. |
