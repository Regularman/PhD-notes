...
| Waste heat from COG can be used to reform methane into hydrogen in a Japanese case study. Although this is very low (0.5GJ/t of steel) due to the limitations of the coke oven off gas flow. Note that coke oven gas is 60% hydrogen. Furthermore, BFG can also be used, which is a mixture of CO, CO2 and N2. A water shift reactor can be used to rransform t |                                                   |
