...
Exergy efficiency can be calculated as $$\frac{E_{GT}+E_{SOFC}+E_{\gamma,water}+M_{CO_2}e_{d,CO_2}-E_{water-pump}}{E_{\gamma, comb}+M_{O_2}e_{d,oxygen-burner}}$$
This is the electrical power obtained from the gas turbine and the SOFC, 
## Further Readings
