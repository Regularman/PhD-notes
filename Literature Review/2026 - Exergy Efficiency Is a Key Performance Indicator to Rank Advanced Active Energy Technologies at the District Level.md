...
$E_{\gamma, comb}$ is the exergy transformation rate of the oxidation network. $$E_{\gamma, comb}=\dot{M_F} \times EXV$$where $EXV$ is the exergy value of the fuel. Further, $M_{CO_2}e_{d,CO_2}$ and 
## Further Readings
