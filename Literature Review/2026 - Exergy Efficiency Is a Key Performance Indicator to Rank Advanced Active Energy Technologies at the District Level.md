...
Ultimately showed the exergy efficiency gain due to the lowering of supply temperature, and the addition of waste heat recovery (rankine cycle) in the SOFC integrated netwrok.
## Limitations
